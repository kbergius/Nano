...
public static class Easing
{
	...
	public static float Interp(float start, float end, float time, float duration, Nano.Math.Easing.Function.Float easingFunc)
	{
	...
	public static Fix64 Interp(Fix64 start, Fix64 end, Fix64 time, Fix64 duration, Nano.Math.Easing.Function.Fixed easingFunc)
	{
		return Interp(start, end, time, duration, Function.Get(easingFunc));
	}
